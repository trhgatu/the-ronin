...
export const Philosophy = () => {
  ...
  return (
    <section 
      ref={containerRef}
      id="philosophy"
      className="relative py-60 bg-black overflow-hidden flex flex-col justify-center border-y border-white/5"
    >
      <div className="absolute inset-0 opacity-[0.02] pointer-events-none bg-[linear-gradient(to_right,#333_1px,transparent_1px),linear-gradient(to_bottom,#333_1px,transparent_1px)] bg-[size:80px_80px]" />
      ...
      <div className="relative z-10 mx-auto max-w-[1400px] px-10 w-full">
        ...
        <div className="mb-40 text-left">
           ...
           <h2 className="text-6xl md:text-8xl lg:text-9xl font-black italic uppercase text-white tracking-tighter leading-[0.8] overflow-visible">
              ...
              <span className="inline-block phil-title-2 text-transparent" style={{ WebkitTextStroke: "1px rgba(255,255,255,0.15)" }}>PHILOSOPHY.</span>
           </h2>
        </div>
        ...
        <div className="flex flex-col md:flex-row gap-20 items-start justify-between">
          <div className="max-w-5xl">
            <blockquote 
                ref={quoteRef}
                className="text-4xl md:text-6xl lg:text-7xl font-extralight italic text-white leading-[1.1] tracking-tight border-l-2 border-accent/20 pl-12 md:pl-20"
            >
          ...
          <div className="flex flex-col items-end gap-6 text-right self-end mt-12 md:mt-0 opacity-40">
            <div className="flex items-center gap-4">
               <span className="text-[12px] font-mono text-white/40 uppercase tracking-[0.6em]">trhgatu // architect</span>
               <div className="h-px w-20 bg-white/10" />
            </div>
            <div className="text-[9px] font-mono text-zinc-800 uppercase tracking-[0.4em] max-w-[250px] leading-relaxed">
      ...
      <div className="absolute top-24 left-24 w-12 h-12 border-t border-l border-white/10" />
      <div className="absolute bottom-24 right-24 w-12 h-12 border-b border-r border-white/10" />
    </section>
  );
};
