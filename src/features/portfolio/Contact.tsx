...
const CONTACT_LINKS = [
  { id: "01", title: "THE ARSENAL", value: "GITHUB", href: "https://github.com/trhgatu" },
  { id: "02", title: "THE NETWORK", value: "LINKEDIN", href: "https://linkedin.com/in/trhgatu" },
  { id: "03", title: "THE DIRECT SCROLL", value: "EMAIL", href: "mailto:trhgatu.dev@gmail.com" },
];
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ opacity: 0.012, filter: "url(#line-torn-filter-contact)" }}
      >
        召
      </div>
      ...
      <div className="mx-auto max-w-[1400px] px-6 md:px-10 w-full relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-start">
          ...
          {/* Left Column (5 Cols): The Structural Panel with Guideline Marks */}
          <div className="lg:col-span-5 flex flex-col items-center lg:items-start z-10 relative contact-reveal">
            <div className="relative w-full p-8 md:p-12 border border-foreground/10 bg-foreground/[0.002] overflow-hidden">
              ...
              <p className="text-lg md:text-xl font-serif font-light text-foreground/60 leading-relaxed mt-10 pl-6 border-l border-foreground/20">
                A blade kept in the scabbard rusts. A vision unbuilt fades.
              </p>

              <div className="text-[9px] font-mono tracking-widest text-foreground/45 mt-8 uppercase font-bold flex items-center gap-2">
                <span>一</span>
                <span>DISPATCH SCROLL TO ALLY</span>
              </div>
            </div>
          </div>
            ...
            <div className="w-full border-t border-foreground/15 flex flex-col contact-reveal">
              {CONTACT_LINKS.map((link) => (
                <a
                  ...
                  className="group relative flex items-center justify-between py-6 md:py-8 border-b border-foreground/10 overflow-hidden cursor-pointer"
                >
                  ...
                  <div className="relative z-10 flex items-center gap-4 pl-2">
                    ...
                    <span className="font-serif text-xl md:text-2xl uppercase tracking-widest text-foreground/75 group-hover:text-foreground group-hover:translate-x-2 transition-all duration-500 font-light">
                      {link.value}
                    </span>
                  </div>
